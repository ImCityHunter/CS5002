...
ArrayList *newArrayList(size_t maxCapacity) {
	...
	list->vals = calloc(list->capacity, sizeof(void*)); // nulls ptrs
...
static bool ensureArrayCapacity(ArrayList *list) {
	...
	if (list->size == list->capacity) {
		...
		void **newVals = realloc(list->vals, newCapacity * sizeof(void*));
 ...
 */
bool addArrayListValAt(ArrayList *list, size_t index, const void *val) {
	// beyond end of list
	if (index > list->size) {
		return false;
	}
 ...
 */
bool addFirstArrayListVal(ArrayList *list, const void *val) {
 ...
 * @return false if exceeds capacity
 */
bool addLastArrayListVal(ArrayList *list, const void *val) {
 ...
 */
bool getArrayListValAt(ArrayList *list, size_t index, const void **val) {
	if (index < list->size) {
		*val = list->vals[index];
		return true;
	}
 ...
 */
bool getFirstArrayListVal(ArrayList *list, const void **val) {
 ...
 * @return false if list is empty
 */
bool getLastArrayListVal(ArrayList *list, const void **val) {
 ...
 * @return false if index out of bounds
 */
bool setArrayListValAt(ArrayList *list, size_t index, const void *val) {
	if (index < list->size) {
		free(list->vals[index]);
		//list->vals[index] = strdup(val);  // must copy input string
		list->vals[index] = malloc(sizeof(void*));
		list->vals[index] = (void*) val;
		return true;
	}
	return false;
}
 ...
 * @return false if list is empty
 */
bool setFirstArrayListVal(ArrayList *list, const void *val) {
 ...
 * @return false if list is empty
 */
bool setLastArrayListVal(ArrayList *list, const void *val) {
	if (list->size == 0) { // prevent negative size_t index
		return false;
	}
 ...
 * @param val pointer to result location if not null; must be freed
 * @return false if index out of bounds
 */
bool deleteArrayListValAt(ArrayList *list, size_t index, void **val) {
	if (index >= list->size) {
		return false;
	}
 ...
 * @return false if list is empty
 */
bool deleteFirstArrayListVal(ArrayList *list, void **val) {
	return deleteArrayListValAt(list, 0, val);
}
 ...
 * @return false if list is empty
 */
bool deleteLastArrayListVal(ArrayList *list, void **val) {
	if (list->size > 0) {
		return deleteArrayListValAt(list, list->size-1, val);
	}
	return false;
}
...
void deleteAllArrayListVals(ArrayList *list) {
	...
	while (deleteLastArrayListVal(list, NULL)) {}
}
