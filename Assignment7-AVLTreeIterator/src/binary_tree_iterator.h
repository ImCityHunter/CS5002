...
typedef struct {
	...
	BinaryTreeIteratorDirection direction;
} BinaryTreeIterator;
...
BinaryTreeIterator* newBinaryTreeIterator(BinaryTreeNode* theTree, BinaryTreeIteratorStyle style, BinaryTreeIteratorDirection direction);
